...
<footer class="w-full bg-[#373435] pt-[24px] md:py-[32px]" id="590_548_0_4323_1920_224">
    <div class="container mx-auto flex flex-col gap-[6px] justify-start items-start w-full">
        <div class="w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[24px]">
            ...
            <div class="w-full border-0 md:border-l md:border-[#ff8110] pl-5">
                ...
                <img src="http://web.freewalking/wp-content/uploads/2026/01/logo-trip.png"
            ...
            <div class="w-full border-0 md:border-l md:border-[#ff8110] pl-5">
                <h4 class="text-[14px] font-bold leading-[17px] text-[#f5f5f5] font-['Inter'] border-b border-[#ff8110] md:border-0 text-center md:text-start mb-[8px] pb-[8px] md:pb-0 md:mb-[16px] w-full">Pago</h4>
                <div class="flex flex-row gap-3 justify-center md:justify-start items-center mt-2">
                    <div class="flex flex-col justify-start items-center">
                        <img src="http://web.freewalking/wp-content/uploads/2026/01/image-70.png" class="w-[44px] h-[28px]"
    ...
    <div class="w-full mt-[40px] mb-[32px] md:mb-0 md:mt-[32px]">
        <p class="text-[14px] text-center font-normal md:!m-0 leading-[20px] text-[#f5f5f5] font-['Nunito_Sans']">FreeWalkingTourCusco.Org <span class="block md:inline">Copyright © 2023 - 2026, All Rights Reserved</span></p>
    </div>
    <div class="block md:hidden w-full bg-[#FF8110] p-3">
        <div class="bg-[#1AB6B6] p-2 text-center">
            <span class="text-white text-base font-semibold">Ver disponibilidad</span>
        </div>
    </div>
</footer>
<?php wp_footer(); ?>
